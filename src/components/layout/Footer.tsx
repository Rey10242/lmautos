        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.facebook.com/autos.luismejia" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-secondary-foreground/10 flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors">
                <Facebook className="h-4 w-4" />
              </a>
              <a href="https://www.instagram.com/lmautos.ctg/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-secondary-foreground/10 flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors">
                <Instagram className="h-4 w-4" />
              </a>
              <a href="https://wa.me/573157525555" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-secondary-foreground/10 flex items-center justify-center hover:bg-[#25D366] hover:text-white transition-colors">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <div className="space-y-1">
                  <a href="tel:+573157525555" className="hover:text-primary transition-colors block">+57 315 752 5555 <span className="text-secondary-foreground/50 text-xs">(Comercial)</span></a>
                  <a href="tel:+573150000990" className="hover:text-primary transition-colors block">+57 315 000 0990 <span className="text-secondary-foreground/50 text-xs">(Créditos)</span></a>
                </div>
              </li>
