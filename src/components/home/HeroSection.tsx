...
const HeroSection = () => {
  ...
  return (
    <section className="relative bg-secondary min-h-[560px] flex items-center overflow-hidden">
      ...
      <div className="relative container py-20">
        <div className="max-w-2xl">
          <span className="inline-block bg-primary text-primary-foreground text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded mb-6">
            Consignataria de Vehículos
          </span>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-secondary-foreground leading-tight mb-6">
          ...
          {/* Quick search bar */}
          <div className="bg-background/10 backdrop-blur-sm border border-secondary-foreground/20 rounded-xl p-4 mb-8 max-w-lg">
